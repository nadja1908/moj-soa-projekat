...
Test-ServiceQuick "Eureka" "http://localhost:8761"
...
for ($i = 1; $i -le 15; $i++) {
    try {
        Write-Host "   Request $i/15..." -NoNewline
...
Write-Host "   -> Dashboards: 'Sistema i Kontejner Metrike'" -ForegroundColor Gray
Write-Host ""
Write-Host "⚡ PROMETHEUS (Raw Metrics): http://localhost:9090" -ForegroundColor Cyan
Write-Host "   -> Try queries:" -ForegroundColor Gray
