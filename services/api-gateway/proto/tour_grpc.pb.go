...
const (
	...
	TourService_GetPublicTour_FullMethodName     = "/tour.TourService/GetPublicTour"
)
...
type TourServiceClient interface {
	...
	GetPublicTour(ctx context.Context, in *GetPublicTourRequest, opts ...grpc.CallOption) (*GetPublicTourResponse, error)
}
...
func (c *tourServiceClient) GetPublicTour(ctx context.Context, in *GetPublicTourRequest, opts ...grpc.CallOption) (*GetPublicTourResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPublicTourResponse)
	err := c.cc.Invoke(ctx, TourService_GetPublicTour_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TourServiceServer interface {
	...
	GetPublicTour(context.Context, *GetPublicTourRequest) (*GetPublicTourResponse, error)
...
func (UnimplementedTourServiceServer) GetPublicTour(context.Context, *GetPublicTourRequest) (*GetPublicTourResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPublicTour not implemented")
}
...
func _TourService_GetPublicTour_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPublicTourRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TourServiceServer).GetPublicTour(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TourService_GetPublicTour_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TourServiceServer).GetPublicTour(ctx, req.(*GetPublicTourRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TourService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPublicTour",
			Handler:    _TourService_GetPublicTour_Handler,
		},
	},
